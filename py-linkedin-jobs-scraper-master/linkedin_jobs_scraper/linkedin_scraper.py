...
from .strategies import Strategy, GuestStrategy
...
class LinkedinScraper:
    ...
    def __init__(
        ...
        info(f'Using strategy {GuestStrategy.__name__}')
        self._strategy = GuestStrategy(self)
    ...
    def __build_search_url(query: Query, location: str = '') -> str:
        ...
        if query.options.filters is not None:
            ...
            # Start offset (strategies may override with page_offset)
            params['start'] = '0'
